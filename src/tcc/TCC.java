...
//INSERT INTO QUESTAO (AREA, DESC_QUESTAO, DESC_ALTERNATIVA_1, DESC_ALTERNATIVA_2, DESC_ALTERNATIVA_3, DESC_ALTERNATIVA_4, DESC_ALTERNATIVA_5, IND_CORRETA, IND_NIVEL) VALUES 
//(9, "(VUNESP) Assinale a alternativa que indica o polinômio que possui os números 0 e 1 como raízes, sendo 0 uma raiz de multiplicidade 3:", "p(x) = x (x3 – 1)", "p(x) = x (x – 1)3", "p(x) = x3 (x – 1)", "p(x) = (x3 – x) (x – 1)", "p(x) = x (x3 + x2 – 2)", 3, 1),
//(9, "(PUCCAMP) Sabe-se que a equação 2x3 + x2 – 6x – 3 = 0 admite uma única raiz racional e não inteira. As demais raízes dessa equação são:", "inteiras e positivas", "inteiras e de sinais contrários", "não reais", "irracionais e positivas", "irracionais e de sinais contrários", 5, 1),
//(9, "Sabe-se que o número complexo i é solução da equação x4 – 3x2 – 4 = 0. Então:", "essa equação tem uma solução de multiplicidade 2", "as soluções dessa equação formam uma progressão", "a equação tem duas soluções reais irracionais", "a equação tem 2 soluções reais racionais", "a equação não tem soluções reais",  4, 1),
//(9, "(MACK) Em R, o produto das soluções da inequação 2x – 3 £ 3 é:", "maior que 8", "6", "2", "1", "0", 5, 2),
//(9, "(PUC) Para os conjuntos A = {a} e B = {a, {A}} podemos afirmar:", "B Ì A", "A = B", "A ÎB", "a = A", "{A}ÎB", 5, 2),
//(9, "(FUVEST) Sendo i a unidade imaginária (i2 = -1) pergunta-se: quantos números reais a existem para os quais (a + i)4 é um número real?", "1", "2", "3", "4", "infinitos", 3, 3),
//(9, "(PUCCAMP) Considere a sentença a2x + 3 > a8, na qual x é uma variável real e a é uma constante real positiva. Essa sentença é verdadeira se, por exemplo:", "x = 3 e a = 1", "x = -3 e a > 1", "x = 3 e a < 1", "x = -2 e a < 1", "x = 2 e a > 1", 4, 3),
//(9, "(UNI- RIO) As probabilidades de três jogadores marcarem um gol cobrando pênalti são, respectivamente, 1/2, 2/5, e 5/6. Se cada um bater um único pênalti, a probabilidade de todos errarem é igual a:", "3%", "5%", "17%", "20%", "25%", 2, 3);
